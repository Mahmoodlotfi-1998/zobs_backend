...
class jdf
{
    ...
    function jdate($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
        ...
        list($j_y,$j_m,$j_d)=$this->gregorian_to_jalalii($date[8],$date[3],$date[2]);
    ...
    function jstrftime($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
        ...
        list($j_y,$j_m,$j_d)=$this->gregorian_to_jalalii($date[7],$date[4],$date[3]);
        $doy=($j_m<7)?(($j_m-1)*31)+$j_d-1:(($j_m-7)*30)+$j_d+185;
        $kab=(((($j_y%33)%4)-1)==((int)(($j_y%33)*0.05)))?1:0;
        $sl=strlen($format);
        $out='';
            ...
            if($m===''){
                ...
                if($s===''){
                    ...
                    if($jm===''){
                        ...
                        if($jd===''){
                            list($gy,$gm,$gd)=jalali_to_gregorians($jdate[0],$jm,$jdate[1]);
                            return mktime($h,$m,$s,$gm);
                        }else{
                            if($jy===''){
                                list($gy,$gm,$gd)=jalali_to_gregorians($jdate[0],$jm,$jd);
                                return mktime($h,$m,$s,$gm,$gd);
                            }else{
                                list($gy,$gm,$gd)=jalali_to_gregorians($jy,$jm,$jd);
...
// $key_a=array('۰','۱','۲','۳','۴','۵','۶','۷','۸','۹',$mf);
    ...
    /*	F	*/
    function gregorian_to_jalalii($gy,$gm,$gd,$mod=''){
    ...
    /*	F	*/
    function jalali_to_gregorians($jy,$jm,$jd,$mod=''){
